...
# Added code
M = StateMonitor(neurons, 'u', record=True, dt=100*defaultclock.dt)
...
fig1.savefig("figures/Fig2Fi.pdf")
fig1.close()
...
fig2.savefig("figures/Fig2Fii.pdf")
fig2.close()

plt.plot(M.t/ms, M.u[0])
plt.axis([0,2500,-150,200])
plt.savefig("figures/voltage traces-Fmax-manipulation.pdf")
